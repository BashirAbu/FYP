...
if "%build_type%"=="Debug" (
    ...
    set LIBS=user32.lib gdi32.lib opengl32.lib Qt6Cored.lib Qt6Guid.lib Qt6Widgetsd.lib shell32.lib
)
...
if "%build_type%"=="Release" (
    ...
    set LIBS=user32.lib gdi32.lib opengl32.lib Qt6Core.lib Qt6Gui.lib Qt6Widgets.lib
)
...
set INCLUDES=/I src /I third_party\qt\include /I third_party\qt\include\QtWidgets
set DEFINES=
